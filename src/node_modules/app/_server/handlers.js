export function renderReact(request, reply) {
  reply(`
    <!DOCTYPE html>
    <html lang="en">
      <head>
      ...
      <body>
        ...
        <script type="text/javascript"
          src="https://cdnjs.cloudflare.com/ajax/libs/leaflet/1.0.0-beta.1/leaflet.js"></script>
        <script type="text/javascript"
          src="https://cdnjs.cloudflare.com/ajax/libs/highcharts/4.1.8/highcharts.js"></script>
        <script type="text/javascript"
          src="https://cdnjs.cloudflare.com/ajax/libs/highcharts/4.1.8/modules/exporting.js"></script>
