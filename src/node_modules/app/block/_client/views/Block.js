...
import {filter} from "app/_shared/utils"
...
class Block extends Component {
  ...
  render() {
    ...
    const filteredData = data && filter(data, record => record.location === 9)
    return <div className="card m-a">
      ...
      <div className="card-block">
        {block && filteredData ? renderBlock(block.widget, block, filteredData) : <LoadingIcon/>}
      </div>
    </div>
  }
