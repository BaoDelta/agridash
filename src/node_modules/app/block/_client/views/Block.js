...
import {autoScroll} from "app/_client/views/common.css"
...
class Block extends Component {
  ...
  render() {
    ...
    return <div className="card m-a">
      ...
      <div className={"card-block " + autoScroll}>
        {block && <h4 className="card-title m-b-md">{block.title}</h4>}
        {data ? renderBlock(block.widget, block, data) : <LoadingIcon/>}
      </div>
    </div>
  }
