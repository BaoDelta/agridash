...
.alpaca-field-tablerow label.control-label
{
    display: none;
}

.alpaca-field-table .actionbar
{
    white-space: nowrap;
    text-align: center;
}
...
/*
.alpaca-field-table .alpaca-control.checkbox input[type='checkbox']
{
    margin-left: -16px;
    margin-top: -3px;
}
...
{
    /* BD: Fix form buttons misalignment
    margin-top: 10px;
    */
    margin: 10px;
    text-align: right;
