...
import {refreshDataSource} from "app/web/actions/form"
import {getArraySchema, getHiddenOptions, getArrayOptions, subscribeArray} from "app/web/forms/common"
    ...
    fields: {
        ...
        postRender(done) {
          ...
          subscribeArray(this, ["name"], () => {
            dispatch(refreshDataSource({
              categories: getCategoryDataSource(this.getValue())
            }))
          })
          done()
        }
      ...
      views: getArrayOptions({
        ...
        postRender(done) {
          ...
          subscribeArray(this, ["name"], () => {
            dispatch(refreshDataSource({
              views: getViewDataSource(this.getValue())
            }))
          })
          done()
        }
