...
function wrapControl(Control, options) {
...
const ToolbarControl = wrapControl(ViewToolbar, {
  position: "topright"
})
...
class MapView extends Component {
  ...
  componentDidMount() {
    const {report, view, resultId} = this.props
    ...
    this.map.addControl(new ToolbarControl())
