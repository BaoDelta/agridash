    ...
    return <div>
      <div className="row">
        <div className="col-sm-4 col-md-3">
          <div className={`text-center ${styles.columnHeader}`}>
            <h3>{report.name}</h3>
          </div>
          <ul className={`nav nav-pills nav-stacked ${styles.viewMenu}`}>
        ...
        <div className="col-sm-8 col-md-9">
          ...
          <div className={styles.view}>
            {data ? <ViewComponent report={report} view={activeView} resultId={resultId} info={info} data={data}/>
            : <Loading/>}
          </div>
        </div>
      </div>
...
export default connect(state => ({info: state.info}))(Report)
