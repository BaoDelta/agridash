...
import {findReportById} from "app/web/views/mock"
...
function renderView(view) {
  const View = viewByType[view.type].component
  return <View/>
}
...
class Report extends Component {
  ...
  render() {
    ...
    const report = findReportById(+params.id)
    const activeViewId = +location.query.view
    const activeView = find(report.views, view => view.id === activeViewId)
    return <div>
      <div className="row">
